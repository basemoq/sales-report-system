...
> **الحالة: لا يعمل مع SurePay.** يرد الخادم بـ**401** على هذا الـ Worker مهما
> كان شكل الطلب (جُرّبت أربعة أشكال)، بينما يُسلّم الصفحة نفسها لجهاز منزلي.
> الحجب على عناوين Cloudflare. النسخة البديلة على Vercel في [`../vercel`](../vercel/README.md).
